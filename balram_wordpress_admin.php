...
add_filter('admin_footer_text', 'left_admin_footer_text_output', 11); //left side
...
function wp_fluency_admin_bar_unhide_menu() {
    global $wp_admin_bar;
...
//add_action( 'wp_before_admin_bar_render', 'wp_fluency_admin_bar_unhide_menu');
// Add Menu Button in Admin Bar

// Another Method to add custom menu in wordpress header
function eshopbox_admin_bar() {
    global $wp_admin_bar;
...
//add_action( 'wp_before_admin_bar_render', 'eshopbox_admin_bar' ); 
// Another Method to add custom menu in wordpress header

// To Replace Title href of Logo in Admin Panel
 add_action( 'admin_head', 'eshop_admin_logo' );
function eshop_admin_logo()
{   
    ?>
    <script type="text/javascript">
        jQuery(document).ready(function($) 
...
add_action( 'admin_head', 'eshop_header_right_menus' );
function eshop_header_right_menus()
{   
    ?>
    <script type="text/javascript">
        jQuery(document).ready(function($) 
...
// To Put text in seperator sidebar menu
 add_action( 'admin_head', 'eshop_seperator_text' );
function eshop_seperator_text()
{   
    ?>
    <script type="text/javascript">
        jQuery(document).ready(function($) 
...
add_action( 'admin_menu', 'renameuser' );  
...
function appearence2website_design() {  
...
add_action( 'admin_menu', 'appearence2website_design' ); 
...
add_filter( 'manage_users_columns', 'my_remove_columns' );
...
function my_remove_columns1( $posts_columns ) {
...
add_filter( 'manage_edit-comments_columns', 'my_remove_columns1' );
...
// to widewordpress version like we see meta ="generator" and wordpress version in view code
